...
function QuickLinks() {
    ...
    return (
        <div id="quicklinks" className="contact-item">
            ...
            <HashLink to="/software-engineering-remote-interns" className={useLocation().pathname === "/software-engineering-remote-interns" ? "link-active size-14" : "link size-14"}>Software Engineering Virtual Internship</HashLink>
